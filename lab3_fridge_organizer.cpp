...
int FridgeOrganizer::number_of_portions() {
	...
	for (list<stack<MealPortion*>*> ::iterator i = stacks.begin(); i != stacks.end(); i++) {
		...
		portion_count = portion_count + cur_stack.size();
	}
